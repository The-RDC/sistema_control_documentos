...
<script src="{{asset('js/jquery-admin/controlEliminarRegistro.js')}}"></script>
<script src="{{asset('js/jquery-admin/seleccionarTodosLosRoles.js')}}"></script>
<script src="{{asset('js/jquery-admin/selectorMultiple.js')}}"></script>
<script src="{{asset('js/jquery-admin/selectorEstadoProcedencia.js')}}"></script>
